...
if(url.indexOf('screen=main')==-1||keyPressRunning)
{
    ...
    var newURL = window.location.pathname +"?" + sitterPart.concat(villagePart,["screen=main"]).join("&");
...
var link = ["https://" + window.location.host + "/game.php?" + sitter + "village=", "&screen=main"];
var pos = {
    s: {
        order: 0,
        dir: 1,
